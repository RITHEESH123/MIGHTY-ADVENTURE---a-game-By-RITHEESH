...
public class CharacterController2D : MonoBehaviour {
	...
	void Update()
	{
		...
		else if(canDoubleJump && CrossPlatformInputManager.GetButtonDown("Jump")) // If can double jump and double jump button pressed then allow player to double jump
        {
			DoJump();
    ...
    // public funtion for enemy bouncing
